...
REM --- Find git. GitHub Desktop does NOT put git on your PATH. ---------------
set "GIT="
...
:push
REM --- Bring down anything already on GitHub, or the push is rejected. -------
"%GIT%" pull --rebase
if errorlevel 1 (
  echo.
...
if errorlevel 1 (
  echo.
  echo   PUSH FAILED.
  echo   Usually the internet, or GitHub needing you to sign in again.
